...
val postgres_version: String by project // todo
val kotlinx_coroutines: String by project
val koin_ktor: String by project
val koin_version: String by project
val koin_ksp_version: String by project
val psql_version: String by project  // todo

plugins {
    kotlin("jvm") version "1.8.10" // Maksim: "1.7.21"
    kotlin("kapt") version "1.5.10"
    id("io.ktor.plugin") version "2.2.4"
    id("org.jetbrains.kotlin.plugin.serialization") version "1.8.10" // Maksim: "1.7.21"
...
//    implementation("org.jetbrains.kotlinx:kotlinx-datetime:0.4.0") // todo - не у верен что нужно, пускай будет как комент
    ...
    //     implementation("org.jetbrains.kotlinx:kotlinx-coroutines-core:1.7.0-Beta") // MAKSIM
